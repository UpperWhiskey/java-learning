    ...
    <div class="container">
      ...
      <div class="row">
        ...
        <div class="col-lg-3">
          ...
          <h1 class="my-4">EventMaker</h1>
          <div class="list-group">
            <a href="${pageContext.request.contextPath}/eventos" class="list-group-item">Eventos</a>
            <a href="${pageContext.request.contextPath}/ingressos-disponiveis" class="list-group-item">Ingressos</a>
          </div>
