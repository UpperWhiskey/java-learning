...
<html lang="en">
  ...
  <head>
    ...
    <title>EventMaker - Criar evento</title>
  ...
  <body>
    ...
    <div class="container">
      ...
      <div class="row">
        ...
        <h1 class="my-4">EventMaker - Criar evento</h1>

        <div class="col-lg-12">

            <div class="container col-md-12 col-lg-12 col-sm-12 login-form">
              <form class="form-horizontal" role="form" method="POST" action="${pageContext.request.contextPath}/evento/criar">
                    <div class="row">
                    ...
                    <div class="row" style="padding-top: 1rem">
                        <div class="col-md-3"></div>
                        <div class="col-md-6">
                            <button type="submit" class="btn btn-success"><i class="fa fa-sign-in"></i> Criar</button>
                        </div>
                    </div>
                </form>
          </div>
