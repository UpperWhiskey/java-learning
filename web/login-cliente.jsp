...
<html lang="en">
  ...
  <body>
    ...
    <div class="container col-md-12 col-lg-12 col-sm-12 login-form">
        <form class="form-horizontal" role="form" method="POST" action="${pageContext.request.contextPath}/acesso/login/cliente">
            <div class="row">
            ...
            <div class="row" style="padding-top: 1rem">
                ...
                <div class="col-md-6">
                    ...
                    <input type="button" class="btn btn-secondary" value="Cadastrar" onclick="window.location='${pageContext.request.contextPath}/acesso/cadastro/cliente'">
                </div>
            </div>
        </form>
    </div>
